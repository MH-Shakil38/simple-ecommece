                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <h3 class="font-weight-bold single_prod_prices">
                            <span style="text-decoration: line-through; color: #555;opacity: .5">৳ {{$product->original_price}}</span>
                            <span style="color: #0088cc">৳ {{$product->selling_price}}</span>
                        </h3>
                        <p class="sku_text"><span>প্রোডাক্ট কোড: </span> <span class="p-0 pr-1">{{$product->product_code}}</span></p>
                        <h4 class="single_prod_in_stock">স্টক :  <span class="{{$product->stock == 1 ? 'text-success ' : 'text-danger'}}">{{$product->stock == 1 ? 'স্টক ইন ' : 'স্টক আউট'}}</span></h4>



                        <form action="https://citystorebd.com/add-cart/2" method="post">
                            <input type="hidden" name="_token" value="RmrYQT0c8w3nngTk2cx7mxhNPSCHEgGQJrT6gGRl">                            <div class="d-flex">
                        ...
                        <h6 class="font-weight-bold text-danger mt-md-3 mt-2">Bkash {{siteInfo()->phone1}} (Personal)</h6>
                    </div>
                                        ...
                                        <tr>
                                            <td class="img">
                                                <a href="{{route('single.product',$info->id)}}">
                                                    <img width="50" src="{{asset($info->image)}}" alt="">
                                                </a>
                                            </td>
                                            <td class="title">
                                                <a href="{{route('single.product',$info->id)}}" class="text-dark">
                                                    {{$info->name}}
                                                </a>
                                            </td>
                                        </tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="nav nav-tabs nav-tabs-mod">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#delivery_return_policy">ডেলিভারি এবং রিটার্ন পলিসি</a>
                            </li>
                        </ul>
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-2 col-6 main-product">
                        <div class="main-product-inner-wrapper text-center">
                            ...
                            <p class="mb-0" style="text-decoration: line-through;color: #b8b8b8">৳ {{$info->original_price}}</p>
                            <p class="font-weight-bold mb-0" style="color: #fca204">৳ {{$info->original_price}}</p>
                            <p class="mb-0 prod_name"><a href="{{route('single.product',$info->id)}}">{{$info->name}}</a></p>
                            <form action="https://citystorebd.com/add-cart/2" method="post">

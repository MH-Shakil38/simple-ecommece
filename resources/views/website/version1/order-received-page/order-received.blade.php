...
<head>
    ...
    <script type="text/javascript"
        src="https://chuijhal.com/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min.js?ver=2.7.0-wc.9.0.2"
    ...
    <script type="text/javascript" id="pys-js-extra">
        ...
        var pysOptions = {
            ...
            "tracking_analytics": {
                ...
                "TrafficLanding": "https:\/\/chuijhal.com\/",
                "TrafficUtms": [],
                "TrafficUtmsId": []
            },
            "woo": {

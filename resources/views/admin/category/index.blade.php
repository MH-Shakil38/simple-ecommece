        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(isset($category))
                            {!! Form::model($category,['route' => ['categories.update',$category->id],'files'=>true]) !!}
                            @method('PUT')
                        @else
                        ...
                        {{Form::label('Show Nav Menu?',null,['class'=>'form-label'])}}
                        {{Form::select('show_menu',[1=>"Show",0=>"Hide"],null,['class'=>'form-control'])}}
                        ...
                        <table class="table" class="cat-table">
                            ...
                            @foreach ($categories as $item)
                                <tr>
                                    ...
                                    <td> <span class="badge {{ $item->show_menu == 1 ? 'badge-success':'badge-danger'}} ">{{ $item->show_menu == 1 ? 'Show':'Hide' }}</span></td>

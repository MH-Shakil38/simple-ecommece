<div class="note-editor note-frame card">
    ...
    <div class="note-toolbar card-header" role="toolbar">
        <div class="note-btn-group btn-group note-style">
            <div class="note-btn-group btn-group">
                <button type="button"
                        ...
                        aria-label="Style" data-original-title="Style"><i
                        class="note-icon-magic"></i></button>
                <div class="note-dropdown-menu dropdown-menu dropdown-style"
                     role="list" aria-label="Style"><a class="dropdown-item"
                                                       href="#" data-value="p"
                                                       role="listitem"
                                                       aria-label="p"><p>Normal</p>
                        ...
                        <pre>Code</pre>
                           ...
                           role="listitem" aria-label="h1"><h1>Header 1</h1></a><a
                        class="dropdown-item" href="#" data-value="h2"
                        role="listitem" aria-label="h2"><h2>Header 2</h2></a><a
                        class="dropdown-item" href="#" data-value="h3"
                        role="listitem" aria-label="h3"><h3>Header 3</h3></a><a
                        class="dropdown-item" href="#" data-value="h4"
                        role="listitem" aria-label="h4"><h4>Header 4</h4></a><a
                        class="dropdown-item" href="#" data-value="h5"
                        role="listitem" aria-label="h5"><h5>Header 5</h5></a><a
                        class="dropdown-item" href="#" data-value="h6"
                        role="listitem" aria-label="h6"><h6>Header 6</h6></a></div>
            </div>
        </div>
                ...
                <button type="button"
                        ...
                        aria-label="Font Family" data-original-title="Font Family">
                                                        <span class="note-current-fontname"
                                                              style="font-family: &quot;Source Sans Pro&quot;;">Source Sans Pro</span>
                </button>
                <div
                    class="note-dropdown-menu dropdown-menu note-check dropdown-fontname"
                    role="list" aria-label="Font Family"><a class="dropdown-item"
                                                            href="#"
                                                            data-value="Arial"
                                                            role="listitem"
                                                            aria-label="Arial"><i
                        ...
                        class="dropdown-item" href="#" data-value="Impact"
                        role="listitem" aria-label="Impact"><i
                            class="note-icon-menu-check"></i> <span
                            style="font-family: 'Impact'">Impact</span></a><a
                        class="dropdown-item" href="#" data-value="Tahoma"
                        ...
                        class="dropdown-item" href="#" data-value="Verdana"
                        role="listitem" aria-label="Verdana"><i
                            class="note-icon-menu-check"></i> <span
                            style="font-family: 'Verdana'">Verdana</span></a><a
                        class="dropdown-item checked" href="#"
                        data-value="Source Sans Pro" role="listitem"
                        aria-label="Source Sans Pro"><i
                            class="note-icon-menu-check"></i> <span
                            style="font-family: 'Source Sans Pro'">Source Sans Pro</span></a><a
                        class="dropdown-item" href="#" data-value="Segoe UI"
                        role="listitem" aria-label="Segoe UI"><i
                            class="note-icon-menu-check"></i> <span
                        ...
                        role="listitem" aria-label="Segoe UI Emoji"><i
                            class="note-icon-menu-check"></i> <span
                            style="font-family: 'Segoe UI Emoji'">Segoe UI Emoji</span></a><a
                        class="dropdown-item" href="#" data-value="Segoe UI Symbol"
                        role="listitem" aria-label="Segoe UI Symbol"><i
                            class="note-icon-menu-check"></i> <span
                            style="font-family: 'Segoe UI Symbol'">Segoe UI Symbol</span></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="note-palette">
                        ...
                        <div>
                            <button type="button"
                                    ...
                                    data-event="backColor" data-value="transparent">
                                Transparent
                            </button>
                        </div>
                        ...
                        <div>
                            <button type="button"
                                    ...
                                    data-value="backColorPicker-16835643972891">
                                Select
                            </button>
                            <input type="color" id="backColorPicker-16835643972891"
                                   class="note-btn note-color-select-btn"
                                   value="#FFFF00"
                                   data-event="backColorPalette-16835643972891">
                        </div>
                        <div class="note-holder-custom"
                             id="backColorPalette-16835643972891"
                             data-event="backColor">
                            <div class="note-color-palette">
                                <div class="note-color-row">
                                    <button type="button" class="note-color-btn"
                    ...
                    <div class="note-palette">
                        ...
                        <div>
                            <button type="button"
                                    class="note-color-select btn btn-light btn-default"
                                    data-event="openPalette"
                                    data-value="foreColorPicker-16835643972891">
                                Select
                            </button>
                            <input type="color" id="foreColorPicker-16835643972891"
                                   class="note-btn note-color-select-btn"
                                   value="#000000"
                                   data-event="foreColorPalette-16835643972891">
                        </div>
                        <div class="note-holder-custom"
                             id="foreColorPalette-16835643972891"
                             data-event="foreColor">
                            <div class="note-color-palette">
                                <div class="note-color-row">
                                    <button type="button" class="note-color-btn"
        ...
        <div class="note-btn-group btn-group note-para">
            ...
            <div class="note-btn-group btn-group">
                <button type="button"
                        class="note-btn btn btn-light btn-sm dropdown-toggle"
                        tabindex="-1" data-toggle="dropdown" title=""
                        aria-label="Paragraph" data-original-title="Paragraph"><i
                ...
                <div class="note-dropdown-menu dropdown-menu" role="list">
                    ...
                    <div class="note-btn-group btn-group note-list">
                        <button type="button" class="note-btn btn btn-light btn-sm"
                                tabindex="-1" title="" aria-label="Outdent (CTRL+[)"
        ...
        <div class="note-btn-group btn-group note-table">
            <div class="note-btn-group btn-group">
                <button type="button"
                        class="note-btn btn btn-light btn-sm dropdown-toggle"
                        tabindex="-1" data-toggle="dropdown" title=""
                        aria-label="Table" data-original-title="Table"><i
        ...
        <div class="note-btn-group btn-group note-insert">
            ...
            <button type="button" class="note-btn btn btn-light btn-sm"
                    ...
                    data-original-title="Picture"><i class="note-icon-picture"></i>
            </button>
            <button type="button" class="note-btn btn btn-light btn-sm"
                    tabindex="-1" title="" aria-label="Video"
                    data-original-title="Video"><i class="note-icon-video"></i>
            </button>
        </div>
        <div class="note-btn-group btn-group note-view">
            ...
            <button type="button"
                    ...
                    data-original-title="Code View"><i class="note-icon-code"></i>
            </button>
            <button type="button" class="note-btn btn btn-light btn-sm"
                    tabindex="-1" title="" aria-label="Help"
                    data-original-title="Help"><i class="note-icon-question"></i>
            </button>
        </div>
    </div>
    <div class="note-editing-area">
        ...
        <div class="note-editable card-block" contenteditable="true" role="textbox"
             aria-multiline="true" spellcheck="true" autocorrect="true"> Place <em>some</em>
        ...
        <div class="popover-content note-children-container"><span><a
            ...
            <div class="note-btn-group btn-group note-link">
                <button type="button" class="note-btn btn btn-light btn-sm"
                        ...
                        data-original-title="Edit"><i class="note-icon-link"></i>
                </button>
                <button type="button" class="note-btn btn btn-light btn-sm"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div
                        ...
                        <label for="note-dialog-image-file-16835643972891"
                               class="note-form-label">Select from
                            files</label><input
                            id="note-dialog-image-file-16835643972891"
                    ...
                    <div class="form-group note-group-image-url"><label
                            for="note-dialog-image-url-16835643972891"
                            class="note-form-label">Image URL</label><input
                            id="note-dialog-image-url-16835643972891"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group note-form-group row-fluid"><label
                            for="note-dialog-video-url-16835643972891"
                            class="note-form-label">Video URL <small
                                class="text-muted">(YouTube, Google Drive, Vimeo,
                                Vine, Instagram, DailyMotion, Youku,
                                Peertube)</small></label><input
                            id="note-dialog-video-url-16835643972891"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body"
                    ...
                    <label style="width: 180px; margin-right: 10px;"><kbd>ESC</kbd></label><span>Escape</span>
                    <div class="help-list-item"></div>
                    <label
                        style="width: 180px; margin-right: 10px;"><kbd>ENTER</kbd></label><span>Insert Paragraph</span>
                    <div class="help-list-item"></div>
                    <label
                        style="width: 180px; margin-right: 10px;"><kbd>CTRL+Z</kbd></label><span>Undo the last command</span>
                    <div class="help-list-item"></div>
                    <label
                        style="width: 180px; margin-right: 10px;"><kbd>CTRL+Y</kbd></label><span>Redo the last command</span>
                    <div class="help-list-item"></div>
                ...
                <div class="modal-footer"><p class="text-center"><a
                            href="http://summernote.org/" target="_blank"
